...
public class GridFragment extends Fragment {
    ...
    private void showRecyclerGrid() {
        ...
        GridRumahAdapter gridRumahAdapter = new GridRumahAdapter(arrayList);
        recyclerView.setAdapter(gridRumahAdapter);

        gridRumahAdapter.setOnItemClickCallback(new GridRumahAdapter.OnItemClickCallback() {
            @Override
            public void onItemClicked(RumahAdat data) {
                showSelectedRumah(data);
                Intent intent = new Intent(getActivity(), Detail.class);
                intent.putExtra("nama", data.getNama());
                intent.putExtra("detail", data.getDetail());
                intent.putExtra("image", data.getFoto());
    ...
    private void showSelectedRumah(RumahAdat rumahAdat) {
        Toast.makeText(getContext(), "Rumah Adat " + rumahAdat.getNama(), Toast.LENGTH_SHORT).show();
    }
}
